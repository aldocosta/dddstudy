...
namespace LivrariaDDD.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer(Configuration.GetConnectionString("LivrariaDDD")));
            ...
            services.AddTransient<IUnityOfWork, UnityOfWorkContext>();
        }
